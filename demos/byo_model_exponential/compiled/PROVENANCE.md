...
After regenerating, run `node tests/wasm/exponential_recovery.mjs` to confirm the
model loads and recovers parameters, and `node tests/browser/dd.mjs` plus the
