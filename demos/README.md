...
| [`magnitude_estimation/`](magnitude_estimation/)             | Capability example for CONTINUOUS responses (canvas slider, Stevens' power law) plus a demo-owned `?simulate=data-only` synthetic participant. |
