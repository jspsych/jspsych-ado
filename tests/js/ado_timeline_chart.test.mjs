...
} from "../../jspsych-ado/ado/ado_timeline.js";
...
test("getParamAxisDomain respects upper_bound after fallback and min-span logic", () => {
  const axis = getParamAxisDomain([
    { trial: 1, mean: 10, sd: 0 },
  ], { y_min: 0, y_max: 7, lower_bound: 0, upper_bound: 7, min_y_span: 0.5 });
...
test("makeParamConvergenceSvg reports axis expansion and true bounds", () => {
  const expanded = makeParamConvergenceSvg([
    { trial: 1, mean: 1.8, sd: 0.1 },
  ], "bias_b", { y_min: -1.5, y_max: 1.5 });
  const bounded = makeParamConvergenceSvg([
    { trial: 1, mean: -0.1, sd: 0.1 },
  ], "k", { lower_bound: 0 });
